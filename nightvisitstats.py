...
def blockvisitstats(sdb, obsdate, update=True):
   ...
   for point in point_list:
       ...
       if propcode in pid_list and bid is not None:
           ...
           #update nightly stats
           PrimarySlewTime+=slewtime.seconds
           TrSlewTime+=trackerslewtime.seconds
           TAcqTime+=acqtime.seconds
           InsAcqTime+=acqtime.seconds
           SciTrackTime+=scitime.seconds
           NightNonScienceTime+=nonsciencetime.seconds
   ...
   #sdb.addstatcols()
   #totals='TotalNonSciTimes=%i, TotalSlewTimes=%i, TotalGuideTimes=%i, TotalAcqTimes=%i, TotalSciTimes=%i, TotalIdleTimes=%i' % (NightNonScienceTime, NightSlewTime, NightGuideTime, NightAcqTime, NightSciTime, NightIdleTime)
   #sdb.update(totals, 'NightInfo', 'NightInfo_Id=%i' % nid)
