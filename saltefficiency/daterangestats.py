...
if __name__=='__main__':
   ...
   with PdfPages('acqstats-%s-%s.pdf' % (sdate, edate)) as pdf:
       ...
       ymin, ymax = ylim()
       text(median(rss_targetacqtimes)+30, ymax - ymax/15, 'Median: %i' % median(rss_targetacqtimes), fontsize=10)
       xticks(np.arange(0, 700, step=50),fontsize=5)
       yticks(fontsize=10)
       ...
       ymin, ymax = ylim()
       text(median(rss_instracqtimes)+30, ymax - ymax/15, 'Median: %i' % median(rss_instracqtimes), fontsize=10)
       ...
       ymin, ymax = ylim()
       text(median(hrs_targetacqtimes)+30, ymax - ymax/15, 'Median: %i' % median(hrs_targetacqtimes),fontsize=10)
       xticks(np.arange(0, 700, step=50),fontsize=7)
       yticks(fontsize=10)
       ...
       ymin, ymax = ylim()
       text(median(hrs_instracqtimes)+30, ymax - ymax/15, 'Median: %i' % median(hrs_instracqtimes), fontsize=10)
       xticks(np.arange(0, 700, step=50),fontsize=8)
       yticks(fontsize=10)
