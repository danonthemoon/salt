...
if __name__=='__main__':
   ...
   with PdfPages('acqstats-%s-%s.pdf' % (sdate, edate)) as pdf:
       ...
       text(400, ymax - ymax/6, 'Mean: %i' % mean(rss_targetacqtimes), fontsize=10)
...
# poissonian 1 sigma intervals would make more sense
       ...
       text(400, ymax - ymax/6, 'Mean: %i' % mean(rss_instracqtimes), fontsize=10)
       ...
       text(400, ymax - ymax/6, 'Mean: %i' % mean(hrs_targetacqtimes), fontsize=10)
       ...
       text(400, ymax - ymax/6, 'Mean: %i' % mean(hrs_instracqtimes), fontsize=10)
