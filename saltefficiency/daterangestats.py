...
if __name__=='__main__':
   ...
   with PdfPages('acqstats-%s-%s.pdf' % (sdate, edate)) as pdf:
       ...
       ymin, ymax = ylim()
       text(median(rss_targetacqtimes)+30, ymax - 30, 'Median: %i' % median(rss_targetacqtimes))
       xticks(np.arange(0, 700, step=50),fontsize=10)
       yticks(fontsize=10)
       ...
       ymin, ymax = ylim()
       text(median(rss_instracqtimes)+30, ymax - 30, 'Median: %i' % median(rss_instracqtimes))
       xticks(np.arange(0, 700, step=50),fontsize=10)
       yticks(fontsize=10)
       ...
       ymin, ymax = ylim()
       text(median(hrs_targetacqtimes)+30, ymax - 30, 'Median: %i' % median(hrs_targetacqtimes))
       xticks(np.arange(0, 700, step=50),fontsize=10)
       yticks(fontsize=10)
       ...
       ymin, ymax = ylim()
       text(median(hrs_instracqtimes)+30, ymax - 30, 'Median: %i' % median(hrs_instracqtimes))
       xticks(np.arange(0, 700, step=50),fontsize=10)
       yticks(fontsize=10)
